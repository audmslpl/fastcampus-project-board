...
class ArticleControllerTest {
    ...
    @DisplayName("[view][GET] 게시글 상세 (게시판) 페이지 - 검색어와 함께 호출")
    @Test
    void givenKeyword_whenSearchingRequestingArticlesDetailView_thenReturnsArticlesView() throws Exception {
    ...
    private UserAccountDto craeteUserAccountDto(){
